...
func main() {
	...
	// here we invoke a method that was embedded from base directly in co
	...
	// here can be seen that a container now implements the describer interface because it embeds base
	var d describer = co
