...
// however, we can use select with a defualt clause to implement non-blocking sends, receives, and even non-blocking multi-way selects
package main
...
func main() {
	...
	// if now it will immediately take the default case
	select {
	case msg := <-messages:
