...
func main() {
	...
	// usually we'll use a constant from time for these layouts, but we can also supply custom layouts
	...
	// for purely numeric repersnentations we can also use standard string formatting with the extracted components of the time value
	fmt.Printf("%d-%02d-%02dT%02d:%02d:%02d-00:00\n",
		t.Year(), t.Month(), t.Day(),
		t.Hour(), t.Month(), t.Second())
