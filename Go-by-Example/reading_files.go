...
// this helper will streamline our error cheks below
func check(e error) {
	if e != nil {
		panic(e)
	}
...
func main() {
	...
	// read some bytes from the begginning of the file
	...
	// there is no built-in reqind, but Seek(0, io.SeekStart) accomplishes this
	...
	// close the file when you're done (usually this would by scheduled immediately after Opening with defer)
	f.Close()
